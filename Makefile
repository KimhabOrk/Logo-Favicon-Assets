...
install-tools:
  ...
  go install github.com/bnb-chain/greenfield-storage-provider/base/types/gfspserver@latest
  go get github.com/bnb-chain/greenfield-storage-provider/modular/metadata/types@latest
